...
export function matchRegExp(value: string, regExp: string, caseSensitive: boolean=true): boolean {
    return regExp ? !!value.match(new RegExp(regExp, caseSensitive ? "" : "i")) : false;
}
